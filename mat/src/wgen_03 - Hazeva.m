...
% study case
    id = 244730; nm = 'Hazeva'; % best choice for RAIN and PET data availability
...
% RAIN
    ...
    sz = 30;  %[days] % smoothing window size 1
    sz2 = 15; %[days] % smoothing window size 2
...
print([nm,'_rain_simul.png'],'-dpng','-r300'); close(ff)
